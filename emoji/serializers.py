...
class PackSerializer(serializers.ModelSerializer):
    ...
    cat_id = serializers.PrimaryKeyRelatedField(queryset=Category.objects.all(), allow_null=True)
    ...
    def create(self, validated_data):
        sticker_list_data = self.context['request'].data.getlist('sticker_list', [])
