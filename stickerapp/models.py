...
class Pack(models.Model):
    ...
    pack_status = models.IntegerField(choices=STATUS_CHOICE, default=1)
...
class countrytag(models.Model):
    relpack = models.ForeignKey(Pack, on_delete=models.CASCADE)
    countrytag = models.CharField(max_length=70)


class religiontag(models.Model):
    religionpack = models.ForeignKey(Pack, on_delete=models.CASCADE)
